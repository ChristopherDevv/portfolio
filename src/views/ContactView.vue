    ...
    <section class="flex flex-col md:flex-row items-start justify-between gap-10">
        <div class="w-full md:w-1/2">
            ...
            <div class="mt-5 flex items-center gap-3">
                ...
                <a href="https://wa.me/522961161813" target="_blank" class="inline-flex items-center justify-center gap-1 font-semibold py-2 px-3 md:px-4 rounded-lg border-2 border-slate-200 hover:border-slate-300 dark:border-slate-700 dark:hover:border-slate-600 transition-all duration-200">
                    <img class="w-5 md:w-6 h-auto" src="https://img.icons8.com/color/48/whatsapp.png" alt="whatsapp"/>
                    <span class="text-[#40C351] text-xs md:text-base">Whatsapp</span>
                </a>
            </div>
